...
By the power of sacrifice, hard work, and sheer will, the company persisted, but the crisis threw workflow into a spiral. The company was forcibly transitioned from physical workflows to its first ever all-digital workflow. It sufficed for a while, but was implemented during crisis mode, and so cracks began to show.
